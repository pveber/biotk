...
(* OASIS_START *)
(* DO NOT EDIT (digest: 1a141bb6b29947f4cf17b411f9abe34c) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/pveber/guizmin";
          synopsis = "OCaml library for building (bioinformatics) pipelines";
          description =
            Some
              "This package provides a library and a syntax extension to build bioinformatics pipelines\n\nThe library is built from a set of components that are both properly typed\nand dependency-aware. The library offers an access to a couple of standard\ntools and databases in bioinformatics.";
          categories = [];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["GzmUtils"; "GzmCore"; "Guizmin"];
                      lib_pack = false;
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Pa_guizmin"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "guizmin";
               ...
               SrcRepo
                 ({
                     ...
                     },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "git://github.com/pveber/guizmin.git";
                      src_repo_browser =
                        Some "https://github.com/pveber/guizmin";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "test_yeast.ml"; });
               Library
                 ({
                     cs_name = "guizmin_unix";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["GzmUcsc"; "Guizmin_bioinfo"; "GzmMBSchema"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "guizmin";
                      lib_findlib_name = Some "bioinfo";
                      lib_findlib_containers = [];
                      })
            ];
          plugins =
     ...
     oasis_digest = Some "W2\021\138\236q\249\202\247\025\003\012\229%Z\198";
     oasis_exec = None;
     oasis_setup_args = [];
     };;
